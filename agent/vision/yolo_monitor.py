"""
NEXORA — YOLO Visual Infrastructure Monitor
----------------------------------------------
...
# NEXORA maps alert classes to YOLO-detectable visual patterns
_ACTION_COLORS = {
...
def generate_dashboard_frame(assets: list[dict], width: int = 640, height: int = 480) -> Optional[bytes]:
    ...
    draw.text((10, 8), "NEXORA Recovery Console", fill=(120, 200, 255))
...
def analyze_fleet_frames(assets: list[dict]) -> dict:
    ...
    temp_path = Path(__file__).parent.parent.parent / "data" / "sample" / "_nexora_frame.png"
