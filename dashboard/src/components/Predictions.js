  ...
  return (
    <div>
      <div className="section-head">
        ...
        <p className="desc">NEXORA projects each asset's failure trend forward to warn of breaches before they occur — this is the shift from reactive monitoring to proactive recovery.</p>
      </div>
