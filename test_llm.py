"""
NEXORA — LLM connectivity smoke test.
...
if not chain:
    ...
    print("NEXORA still runs fully on its deterministic rule engine without any key.")
    sys.exit(0)
...
try:
    ...
    print("Check your key(s) and network. NEXORA will use the rule engine in the meantime.")
