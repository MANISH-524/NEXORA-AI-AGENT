...
NEXORA's deterministic compute_risk/decide_action), so this is a real held-out
...
ADAPTER = ROOT / "models" / "nexora-slm-lora"
...
def main(args):
    ...
    base = (ADAPTER / "nexora_base.txt").read_text(encoding="utf-8").strip()
